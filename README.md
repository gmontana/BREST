...
```
### Docker Image
If you are familiar with docker, you can leverage the BREST-Risk [BREST docker container](https://1drv.ms/u/c/8d3f676f686fa7bf/ERNujo_yvpFFijjIDXR6kqcByEvM7khgkAWj24NDn_LfpA?e=Haeyuy) which has all the depedencies preinstalled and the trained BREST model. (Please get in touch for the password to download the docker container or pre-trained model weights. `g.montana@warwick.ac.uk`)
```bash
